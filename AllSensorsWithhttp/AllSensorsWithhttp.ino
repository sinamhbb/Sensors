...
#define I2C_SDA_FOR_BME 16
#define I2C_SCL_FOR_BME 17
...
void setup() {
  ...
  if (state == 1) {
    ...
    pinMode(22, OUTPUT);       // 22 = scl-- Clock goes from master to peripherical
    pinMode(21, INPUT_PULLUP); // 21 = sda -- Data should be internally pulled up (or 4.7K pullup to 3.3v)
